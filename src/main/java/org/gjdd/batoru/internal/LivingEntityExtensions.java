...
public interface LivingEntityExtensions {
    ...
    /**
     * 엔티티가 {@link org.gjdd.batoru.effect.Pushed} 상태 효과를 가졌을 때 강제되는 속도를 반환합니다.
     *
     * @return 강제되는 속도
     */
    ...
    /**
     * 엔티티가 {@link org.gjdd.batoru.effect.Pushed} 상태 효과를 가졌을 때 강제되는 속도를 설정합니다.
     *
     * @param pushedVelocity 강제되는 속도
     */
